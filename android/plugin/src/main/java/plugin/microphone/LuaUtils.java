...
abstract class LuaUtils {
	...
	static String IS_ERROR_KEY = "is_error";
	static String ERROR_CODE_KEY = "error_code";
	...
	static void checkArgCount(LuaState L, int countFrom, int countTo) {
		...
		if ((count < countFrom) || (count > countTo)) {
			throw new LuaRuntimeException("This function requires from " + countFrom + " to " + countTo + " arguments. Got " + count + ".");
		}
	}
